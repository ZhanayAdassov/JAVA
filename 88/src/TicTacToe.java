...
public class TicTacToe extends JFrame {
    ...
    public TicTacToe() {
        ...
        for (int i = 0; i < SIZE; i++) {
            for (int j = 0; j < SIZE; j++) {
                ...
                buttons[i][j].setFont(new Font("Seriff", Font.BOLD, (400 / SIZE )));
                buttons[i][j].setText("");
        ...
        buttons[0][0].addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (buttons[0][0].getText().equals("") && !checkWin() && !isFull()) {
                    ...
                    buttons[0][0].setBackground(new Color(13, 243, 23));
        ...
        buttons[0][1].addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (buttons[0][1].getText().equals("") && !checkWin() && !isFull()) {
                    ...
                    buttons[0][1].setBackground(new Color(36, 238, 46));
                    if (!checkWin() && !isFull()) aiTurn();
                }
            }
        });
        buttons[0][2].addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (buttons[0][2].getText().equals("") && !checkWin() && !isFull()) {
                    ...
                    buttons[0][2].setBackground(new Color(13, 243, 23));
                    if (!checkWin() && !isFull()) aiTurn();
                }
            }
        });
        buttons[1][0].addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (buttons[1][0].getText().equals("") && !checkWin() && !isFull()) {
                    ...
                    buttons[1][0].setBackground(new Color(13, 243, 23));
                    if (!checkWin() && !isFull()) aiTurn();
                }
            }
        });
        buttons[1][1].addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (buttons[1][1].getText().equals("") && !checkWin() && !isFull()) {
                    ...
                    buttons[1][1].setBackground(new Color(13, 243, 23));
                    if (!checkWin() && !isFull()) aiTurn();
                }
            }
        });
        buttons[1][2].addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (buttons[1][2].getText().equals("") && !checkWin() && !isFull()) {
                    ...
                    buttons[1][2].setBackground(new Color(13, 243, 23));
                    if (!checkWin() && !isFull()) aiTurn();
                }
            }
        });
        buttons[2][0].addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (buttons[2][0].getText().equals("") && !checkWin() && !isFull()) {
                    ...
                    buttons[2][0].setBackground(new Color(13, 243, 23));
                    if (!checkWin() && !isFull()) aiTurn();
                }
            }
        });
        buttons[2][1].addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (buttons[2][1].getText().equals("") && !checkWin() && !isFull()) {
                    ...
                    buttons[2][1].setBackground(new Color(13, 243, 23));
                    if (!checkWin() && !isFull()) aiTurn();
                }
            }
        });
        buttons[2][2].addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (buttons[2][2].getText().equals("") && !checkWin() && !isFull()) {
                    ...
                    buttons[2][2].setBackground(new Color(13, 243, 23));
                    if (!checkWin() && !isFull()) aiTurn();
                }
            }
        });
    ...
    boolean isFull() {
        ...
        int reply = JOptionPane.showConfirmDialog(null, "НАЧАТЬ ЗАНОВО", "МЕНЮ", JOptionPane.YES_NO_OPTION);
    ...
    void aiTurn() {
        ...
        buttons[i][j].setBackground(new Color(210, 11, 234));
        checkWin();
    }
            ...
            for (int j = 0; j < SIZE; j++) {
                if (buttons[i][j].getText().equals("X")) {
                    ...
                    if (countXH == SIZE) {
                        ...
                        int reply = JOptionPane.showConfirmDialog(null, "ВЫ ВЫИГРАЛИ! НАЧАТЬ ЗАНОВО?", "МЕНЮ", JOptionPane.YES_NO_OPTION);
                        if (reply == JOptionPane.YES_OPTION){
                            startNew();
                        } else {
                            System.exit(0);
                ...
                if (buttons[i][j].getText().equals("O")) {
                    ...
                    if (countOH == SIZE) {
                        ...
                        int reply = JOptionPane.showConfirmDialog(null, "ВЫ ПРОИГРАЛИ! НАЧАТЬ ЗАНОВО?", "МЕНЮ", JOptionPane.YES_NO_OPTION);
                        if (reply == JOptionPane.YES_OPTION){
                            startNew();
                        } else {
                            System.exit(0);
